...
@DisplayName("GET /genesis [mainnet]")
public final class GetMainnetGenesisTests extends AbstractApiTest {

    @Override
    protected DeploymentOptions deploymentOptions() {
        return new DeploymentOptions()
                .setConfig(new JsonObject()
                        .put("network", MAINNET.name()));
    }
    ...
    void testGetGenesis(Vertx vertx, VertxTestContext context, WebClient client) {
        testRequest(client, HttpMethod.GET, "/genesis")
                .expect(
                    ...
                    assertFieldEquals("network_magic", 764824073),
