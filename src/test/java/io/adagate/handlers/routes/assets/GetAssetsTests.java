        ...
        testRequest(client, HttpMethod.GET, "/assets")
            .expect(
                ...
                expectFirstArrayElement(
                    JsonObjectAsserts.assertFieldEquals("asset", "00000002df633853f6a47465c9496721d2d5b1291b8398016c0e87ae6e7574636f696e"),
                    JsonObjectAsserts.assertFieldEquals("quantity", "1")
                ),
                expectNthArrayElement(
                    1,
                    JsonObjectAsserts.assertFieldEquals("asset", "3a9241cd79895e3a8d65261b40077d4437ce71e9d7c8c6c00e3f658e4669727374636f696e"),
                    JsonObjectAsserts.assertFieldEquals("quantity", "1")
                )
            )
            .send(context)
    ...
    void testGetAssetsParameterized_01(Vertx vertx, VertxTestContext context, WebClient client) {
        testRequest(client, HttpMethod.GET, "/assets")
            ...
            .expect(
                ...
                expectNthArrayElement(
                    1,
                    JsonObjectAsserts.assertFieldEquals("asset", "ac3f4224723e2ed9d166478662f6e48bae9ddf0fc5ee58f54f6c322943454e54"),
                    JsonObjectAsserts.assertFieldEquals("quantity", "10000000")
                ),
                expectNthArrayElement(
                    2,
                    JsonObjectAsserts.assertFieldEquals("asset", "12e65fa3585d80cba39dcf4f59363bb68b77f9d3c0784734427b151754534c41"),
