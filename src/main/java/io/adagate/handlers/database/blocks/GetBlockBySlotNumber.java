...
/**
 * Builds a SQL query to retrieve specific block for a given slot number.
 *
 * - Example Result:
 * <code>
 *     {
 ...
 * </code>
 */
public final class GetBlockBySlotNumber extends AbstractBlockHandler {

    public static final String ADDRESS = "io.adagate.blocks.get.by.slot";
    private static final String QUERY = new StringBuilder()
            ...
            .append("WHERE ")
                .append("b.slot_no = #{slot}")
            .toString();

    public GetBlockBySlotNumber(PgPool pool) { super(pool); }
    ...
    public void handle(Message<Object> message) {
        SqlTemplate
            ...
            .execute(singletonMap("slot", message.body()))
