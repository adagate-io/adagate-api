...
public final class GetRetiringPools extends AbstractPoolsHandler {

    public static final String ADDRESS = "io.adagate.pools.retiring.list";
    private static final String QUERY = new StringBuilder()
        ...
        .append("ORDER BY pr.retiring_epoch %s ")
        .append("OFFSET #{page} ")
        .append("LIMIT #{count} ")
        .toString();

    public GetRetiringPools(PgPool client) { super(client); }
