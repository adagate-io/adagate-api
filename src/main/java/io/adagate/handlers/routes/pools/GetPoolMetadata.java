...
import static io.adagate.handlers.database.pools.GetPoolMetadata.ADDRESS;
import static io.netty.handler.codec.http.HttpResponseStatus.OK;
import static io.vertx.core.buffer.Buffer.buffer;

public final class GetPoolMetadata extends AbstractRouteHandler {

    public GetPoolMetadata(Vertx vertx) { super(vertx); }
