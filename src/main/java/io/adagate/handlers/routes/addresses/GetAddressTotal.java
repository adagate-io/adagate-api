...
import static io.adagate.handlers.database.addresses.GetAddressTotal.ADDRESS;
import static io.netty.handler.codec.http.HttpResponseStatus.OK;
import static io.vertx.core.buffer.Buffer.buffer;
import static java.util.Objects.isNull;

public final class GetAddressTotal extends AbstractRouteHandler {

    public GetAddressTotal(Vertx vertx) { super(vertx); }
